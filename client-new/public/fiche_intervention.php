...
$data = $controller->handleRequest($_GET, $_POST, $_SESSION);
extract($data);
    ...
    <div class="dashboard-content">
        <div class="container">
                                ...
                                <select id="client_id" name="client_id" required <?= $action === 'edit' ? 'disabled' : '' ?>>
                                    ...
                                    <?php foreach ($clients as $client): ?>
                                        <option value="<?= $client['Numero_Client'] ?>" 
                                            ...
                                            N°<?= htmlspecialchars($client['Numero_Client'] . ' - ' . $client['Raison_Sociale']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                                <?php if ($action === 'edit'): ?>
                    ...
                    <div style="padding: 2rem;">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                            ...
                            <div>
                                ...
                                <p><strong>Client:</strong> <?= $intervention['client_id'] ? htmlspecialchars('N°' . $intervention['client_id'] . ' - ' . $intervention['client_nom']) : 'N/A' ?></p>
            ...
            <?php else: ?>
                ...
                <!-- SQL query moved to InterventionController -->
                                ...
                                <?php else: ?>
                                    <?php foreach ($all_interventions as $interv): ?>
                                        <tr>
                                            ...
                                            <td><?= $interv['client_id'] ? htmlspecialchars('N°' . $interv['client_id'] . ' - ' . $interv['client_nom']) : 'N/A' ?></td>
